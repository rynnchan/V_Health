public class Average{
    ...
    Average(double ave_calorie,double ave_protein,double ave_lipid,double ave_carbohydrate,double ave_salt,double ave_red,double ave_green,double ave_yellow,int start,int today){
