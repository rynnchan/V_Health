...
public class Read_json{
    ...
    // JSONから今日の摂取カロリーの合計を受け取る関数
    public static double read_today_calorie(JsonNode root){
        double today_calorie = root.get("today_calorie").doubleValue();
        return today_calorie;
    }

    // JSONから今日の摂取タンパク質の合計を受け取る関数
    public static double read_today_protein(JsonNode root){
        double today_protein = root.get("today_protein").doubleValue();
        return today_protein;
    }

    // JSONから今日の摂取脂質の合計を受け取る関数
    public static double read_today_lipid(JsonNode root){
        double today_lipid = root.get("today_lipid").doubleValue();
        return today_lipid;
    }

    // JSONから今日の摂取炭水化物の合計を受け取る関数
    public static double read_today_carbohydrate(JsonNode root){
        double today_carbohydrate = root.get("today_carbohydrate").doubleValue();
        return today_carbohydrate;
    }

    // JSONから今日の摂取塩分の合計を受け取る関数
    public static double read_today_salt(JsonNode root){
        double today_salt = root.get("today_salt").doubleValue();
        return today_salt;
    }

    // JSONから今日の赤の点数の合計を受け取る関数
    public static double read_today_red(JsonNode root){
        double today_red = root.get("today_red").doubleValue();
        return today_red;
    }

    // JSONから今日の緑の点数の合計を受け取る関数
    public static double read_today_green(JsonNode root){
        double today_green = root.get("today_green").doubleValue();
        return today_green;
    }

    // JSONから今日の黃の点数の合計を受け取る関数
    public static double read_today_yellow(JsonNode root){
        double today_yellow = root.get("today_yellow").doubleValue();
        return today_yellow;
    }
}